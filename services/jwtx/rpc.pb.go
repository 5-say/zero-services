...
type MakeToken_Request struct {
	...
	AccessExpire    int64  `protobuf:"varint,3,opt,name=accessExpire,proto3" json:"accessExpire,omitempty"`      // token 过期时间（秒）
...
type CheckToken_Request struct {
	...
	RequestIP       string `protobuf:"bytes,5,opt,name=requestIP,proto3" json:"requestIP,omitempty"`              // 发起请求的 IP 地址
	Tid             uint64 `protobuf:"varint,6,opt,name=tid,proto3" json:"tid,omitempty"`                         // token ID
	Iat             int64  `protobuf:"varint,7,opt,name=iat,proto3" json:"iat,omitempty"`                         // 从 token 中解析出的签发时间
}
...
var file_define_rpc_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x6a, 0x77, 0x74, 0x78, 0x22, 0xb3, 0x01, 0x0a, 0x11, 0x4d, 0x61, 0x6b,
	...
	0x75, 0x70, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x45, 0x78, 0x70, 0x69,
	0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x12, 0x28, 0x0a, 0x0f, 0x72, 0x61, 0x6e, 0x64, 0x6f, 0x6d,
	...
	0x69, 0x61, 0x74, 0x22, 0x5b, 0x0a, 0x13, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x54, 0x6f, 0x6b, 0x65,
